...
// All code reformatted according to Prettier/lint warnings: added missing commas, fixed formatting, updated chained calls, and used double quotes for string literals.
