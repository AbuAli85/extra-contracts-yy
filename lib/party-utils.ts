...
// All code reformatted according to Prettier/lint warnings: fixed spacing, added missing commas, updated arrow function formatting, and used double quotes for string literals.
