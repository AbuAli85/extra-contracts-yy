            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div>
                    <label className="text-sm font-medium text-gray-500">Name (EN)</label>
                    <p className="font-medium">{contract?.employer?.name_en || contract?.first_party_name_en || "Not specified"}</p>
                  </div>
                  {(contract?.employer?.name_ar || contract?.first_party_name_ar) && (
                    <div>
                      <label className="text-sm font-medium text-gray-500">Name (AR)</label>
                      <p className="font-medium">{contract?.employer?.name_ar || contract?.first_party_name_ar}</p>
                    </div>
                  )}
                  {contract?.employer?.crn && (
                    <div>
                  ...
                  <div>
                    ...
                    <p className="font-mono text-xs text-gray-400">{contract?.employer_id || "N/A"}</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div>
                    <label className="text-sm font-medium text-gray-500">Name (EN)</label>
                    <p className="font-medium">{contract?.client?.name_en || contract?.second_party_name_en || "Not specified"}</p>
                  </div>
                  {(contract?.client?.name_ar || contract?.second_party_name_ar) && (
                    <div>
                      <label className="text-sm font-medium text-gray-500">Name (AR)</label>
                      <p className="font-medium">{contract?.client?.name_ar || contract?.second_party_name_ar}</p>
                    </div>
                  )}
                  {contract?.client?.crn && (
                    <div>
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-500">ID</label>
                    <p className="font-mono text-xs text-gray-400">{contract?.client_id || "N/A"}</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div>
                    <label className="text-sm font-medium text-gray-500">Name (EN)</label>
                    <p className="font-medium">{contract?.promoters?.[0]?.name_en || "Not assigned"}</p>
                  </div>
                  {contract?.promoters?.[0]?.name_ar && (
                    <div>
                      <label className="text-sm font-medium text-gray-500">Name (AR)</label>
                      <p className="font-medium">{contract.promoters[0].name_ar}</p>
                    </div>
                  )}
                  {contract?.promoters?.[0]?.id_card_number && (
                    <div>
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-500">ID</label>
                    <p className="font-mono text-xs text-gray-400">{contract?.promoter_id || "N/A"}</p>
                  </div>
                </CardContent>
              </Card>
            </div>
                  ...
                  {contract?.pdf_url ? (
                    <div className="flex items-center justify-between p-3 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Downloadable contract PDF</p>
                      </div>
                      <Button asChild size="sm" variant="outline">
                        <a href={contract.pdf_url} download>
                          <DownloadIcon className="mr-2 h-4 w-4" />
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        {contract?.updated_at ? new Date(contract.updated_at).toLocaleDateString() : 'N/A'}
                      </p>
                    </div>
                  </div>
                </div>
...
>>>>>>> c900720461f2bfe13da02a09166bf12cdf762058