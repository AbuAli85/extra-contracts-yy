                  ...
                  <div className="space-y-3">
                    ...
                    {contract?.employer?.phone && (
                      <div>
                        ...
                        <p className="text-gray-700 mt-1">{contract.employer.phone}</p>
                      </div>
                    )}
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    ...
                    {contract?.client?.phone && (
                      <div>
                        <label className="text-sm font-medium text-gray-500">Phone</label>
                        <p className="text-gray-700 mt-1">{contract.client.phone}</p>
                      </div>
                    )}
                        ...
                        <div key={promoter.id || index} className="p-4 border border-gray-200 rounded-lg">
                          <div className="space-y-2">
                            <h4 className="font-semibold text-gray-900">
                              {promoter.name_en || "Unnamed Promoter"}
                            </h4>
                            
                            {promoter.name_ar && (
                              <p className="text-sm text-gray-600" dir="rtl">{promoter.name_ar}</p>
                            )}
