...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ...
    className={cn(
      ...
      "data-[orientation=horizontal]:slide-in-from-top-1 data-[orientation=vertical]:slide-in-from-left-1",
      "data-[orientation=horizontal]:data-[motion^=from-]:slide-in-from-top-1 data-[orientation=horizontal]:data-[motion^=to-]:slide-out-to-top-1",
      "data-[orientation=vertical]:data-[motion^=from-]:slide-in-from-left-1 data-[orientation=vertical]:data-[motion^=to-]:slide-out-to-left-1",
      className,
    )}
    {...props}
  />
